...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/EvaSprt)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ? 👇🏻</b>"""
    ...
    I_CUDNT = """<b>ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {}</b>"""
...
എല്ലാ മെസ്സേജും 𝟷 മിനിറ്റിനുള്ളിൽ ഡിലീറ്റ് ആകും ⁉️

ʟᴏᴏᴋ ᴀᴛ ᴛʜᴇ ɴᴇxᴛ ᴘᴀɢᴇ ᴀʟꜱᴏ 🪄

അടുത്ത പേജ് കൂടി പരിശോധിക്കുക 🪄
